...
int main()
{
   ...
   int x, y, temp = 0;
   int inicial = 0;
   char temporal[CHARS]; ///arreglo para la impresión de las letras adivinadas.
   ...
   do {
      ...
      for(i=0;i<cantidad;i++)
      {
         if(rep[i] == pal) ///Aquí se empieza a verificar si se ha repetido una palabra
         {
            repet = 1;
            break;
         }
...
/*
Nombre de función: freqconsonante.
